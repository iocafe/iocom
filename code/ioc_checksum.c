...
****************************************************************************************************
  ...
  The ioc_checksum() function calculates checksum for the buffer given as an argument.

  This is modbus checksum.
...
****************************************************************************************************
*/
os_ushort ioc_checksum(
    os_uchar *buf,
    int n)
{
    static const os_ushort crc_table[] = {
...
****************************************************************************************************
  ...
  The ioc_test_checksum() function calculates checksum for the test strings and checks that it
  ...
  Modbus CRC-16 for test string "123456789" should be 0x4B37.

  @param   buf Pointer to the buffer.
  @param   n Number of bytes in buffer.
  @return  Nonzero of all good, zero if failed.

****************************************************************************************************
*/
int ioc_test_checksum(
    void)
{
    os_ushort
        crc;
    ...
    crc = ioc_checksum(test, sizeof(test)-1);
