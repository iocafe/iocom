...
def runcmd(cmd):
    try:
        ...
        if exit_status is not None:
            print ("arduino,config_to_c_code.py: Command \'" + cmd + "\'failed with status " + str(exit_status))

    except Exception as e:
        print(f"arduino,config_to_c_code.py: os.popen(\'" + cmd + "\') failed, exception:" + str(e))
