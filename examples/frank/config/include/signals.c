...
void frank_init_signal_struct(frank_t *s)
{
  ...
  s->exp.hdr.mblk_sz = FRANK_EXP_MBLK_SZ;
 ...
 /* test */
  ...
  s->imp.hdr.mblk_sz = FRANK_IMP_MBLK_SZ;
 ...
 /* restart */
  ...
  s->conf_exp.hdr.mblk_sz = FRANK_CONF_EXP_MBLK_SZ;
 ...
 /* frd_buf */
  ...
  s->conf_imp.hdr.mblk_sz = FRANK_CONF_IMP_MBLK_SZ;
