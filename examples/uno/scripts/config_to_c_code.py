...
MYAPPCONFIG = MYCODEROOT + '/iocom/examples/uno/config'
...
def runcmd(cmd):
    try:
        ...
        if exit_status is not None:
            print ("uno,config_to_c_code.py: Command \'" + cmd + "\'failed with status " + str(exit_status))

    except Exception as e:
        print(f"uno,config_to_c_code.py: os.popen(\'" + cmd + "\') failed, exception:" + str(e))
