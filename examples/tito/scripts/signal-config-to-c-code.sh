...
python3 ${MYSCRIPTS}/signals-to-c.py -controller-static ${MYCODEROOT}/iocom/examples/gina/config/signals/gina-signals.json -o ${MYCONFIG}/include/gina-for-${MYAPP}.c
