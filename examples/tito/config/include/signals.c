...
{
  os_memclear(s, sizeof(tito_t));
  s->exp.hdr.mblk_name = "exp";
  s->exp.hdr.n_signals = 2;
  s->exp.hdr.mblk_sz = TITO_EXP_MBLK_SZ;
 ...
 /* test */
  ...
  s->imp.hdr.mblk_sz = TITO_IMP_MBLK_SZ;
 ...
 /* restart */
  ...
  s->conf_exp.hdr.mblk_sz = TITO_CONF_EXP_MBLK_SZ;
 ...
 /* frd_head */
  ...
  s->conf_imp.hdr.mblk_sz = TITO_CONF_IMP_MBLK_SZ;
