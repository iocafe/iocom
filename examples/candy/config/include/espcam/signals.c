...
{
  {
    {"exp", &ioboard_exp, 6, CANDY_EXP_MBLK_SZ, (iocSignal*)&candy.exp.ambient},
    ...
    {21, 1, OS_CHAR, &ioboard_exp, OS_NULL}, /* rec_state */
    {23, 1, OS_INT, &ioboard_exp, OS_NULL}, /* rec_head */
    {28, 8192, OS_UCHAR, &ioboard_exp, OS_NULL} /* rec_buf */
  },

  {
    {"imp", &ioboard_imp, 6, CANDY_IMP_MBLK_SZ, (iocSignal*)&candy.imp.on},
    {0, 1, OS_BOOLEAN, &ioboard_imp, OS_NULL}, /* on */
    {1, 1, OS_UINT|IOC_PIN_PTR, &ioboard_imp, &pins.pwm.headlight}, /* headlight */
    {6, 10, OS_STR, &ioboard_imp, OS_NULL}, /* set_resolution */
    {17, 1, OS_CHAR, &ioboard_imp, OS_NULL}, /* rec_cmd */
    {19, 1, OS_UCHAR, &ioboard_imp, OS_NULL}, /* rec_select */
    {21, 1, OS_INT, &ioboard_imp, OS_NULL} /* rec_tail */
  },
