...
static os_short io_POTENTIOMETER_prm[]= {PIN_DELAY, 11, PIN_SPEED, 3};
...
static os_short io_SERVO_prm[]= {PIN_INIT, 2048, PIN_RESOLUTION, 12, PIN_FREQENCY, 50};
const Pin io_SERVO = {"SERVO", PIN_PWM, 0, 32, io_SERVO_prm, sizeof(io_SERVO_prm)/sizeof(os_short), OS_NULL, &io_POTENTIOMETER};
static os_short io_DIMMER_LED_prm[]= {PIN_INIT, 0, PIN_RESOLUTION, 12, PIN_FREQENCY, 5000};
