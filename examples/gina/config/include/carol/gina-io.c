...
/* Parameters for pwm */
static os_short pins_pwm_servo_prm[]= {PIN_RV, PIN_RV, PIN_INIT, 2048, PIN_RESOLUTION, 12, PIN_FREQENCY, 50};
static os_short pins_pwm_dimmer_led_prm[]= {PIN_RV, PIN_RV, PIN_INIT, 0, PIN_RESOLUTION, 12, PIN_FREQENCY, 5000};
...
const pins_t pins =
{
  ...
  {{9, &pins.outputs.led_builtin}, /* outputs */
    {PIN_OUTPUT, 0, 21, pins_outputs_led_builtin_prm, sizeof(pins_outputs_led_builtin_prm)/sizeof(os_short), OS_NULL, &gina.imp.led_builtin}, /* led_builtin */
