...
/* Parameters for pwm */
static os_short pins_pwm_servo_prm[]= {PIN_RV, PIN_RV, PIN_RESOLUTION, 12, PIN_FREQENCY, 50, PIN_INIT, 2048};
static os_short pins_pwm_dimmer_led_prm[]= {PIN_RV, PIN_RV, PIN_RESOLUTION, 12, PIN_FREQENCY, 5000, PIN_INIT, 0};
