...
{
  {
    ...
    {36, 1, OS_BOOLEAN, 0, &ioboard_UP, &pins.outputs.A}, /* A */
    {37, 1, OS_BOOLEAN, 0, &ioboard_UP, &pins.outputs.B}, /* B */
    {38, 1, OS_BOOLEAN, 0, &ioboard_UP, &pins.outputs.C}, /* C */
    {39, 1, OS_BOOLEAN, 0, &ioboard_UP, &pins.outputs.D}, /* D */
    {40, 1, OS_BOOLEAN, 0, &ioboard_UP, &pins.outputs.E}, /* E */
    {41, 1, OS_BOOLEAN, 0, &ioboard_UP, &pins.outputs.F}, /* F */
    {42, 1, OS_BOOLEAN, 0, &ioboard_UP, &pins.outputs.G}, /* G */
    {43, 1, OS_BOOLEAN, 0, &ioboard_UP, &pins.outputs.H} /* H */
  },

  {
    {&ioboard_DOWN, 4, GINA_DOWN_MBLK_SZ, &gina.down.seven_segment},
    {0, 8, OS_BOOLEAN, 0, &ioboard_DOWN, OS_NULL}, /* seven_segment */
    {9, 1, OS_SHORT, 0, &ioboard_DOWN, &pins.pwm.servo}, /* servo */
    {12, 1, OS_SHORT, 0, &ioboard_DOWN, &pins.pwm.dimmer_led}, /* dimmer_led */
    {15, 1, OS_BOOLEAN, 0, &ioboard_DOWN, &pins.outputs.led_builtin} /* led_builtin */
  }
};
