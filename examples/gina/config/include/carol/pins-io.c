...
/* Parameters for pwm */
static os_ushort pins_pwm_ccd_clock_prm[]= {PIN_RV, PIN_RV, PIN_FREQENCY_KHZ, 800, PIN_HPOINT, 0, PIN_INIT, 1, PIN_TIMER_SELECT, 0, PIN_RESOLUTION, 1};
static os_ushort pins_pwm_dimmer_led_prm[]= {PIN_RV, PIN_RV, PIN_INIT, 0, PIN_FREQENCY, 5000, PIN_RESOLUTION, 12, PIN_MAX, 4095};
...
static os_ushort pins_cameras_ccd_prm[]= {PIN_RV, PIN_RV, PIN_C, 32, PIN_A, 36, PIN_C_BANK, 2, PIN_TIMER_SELECT, 1, PIN_D, 35, PIN_B_BANK, 1, PIN_B, 21};
