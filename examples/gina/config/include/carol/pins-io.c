...
/* Parameters for spi */
static os_ushort pins_spi_tft_spi_prm[]= {PIN_RV, PIN_RV, PIN_MISO, 19, PIN_SCLK, 18, PIN_DC, 2, PIN_MOSI, 23};
...
static os_ushort pins_cameras_ccd_prm[]= {PIN_RV, PIN_RV, PIN_B_BANK, 1, PIN_B, 21, PIN_D, 35, PIN_C_BANK, 2, PIN_TIMER_SELECT, 1, PIN_C, 32, PIN_A, 36};
