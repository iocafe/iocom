...
/* Parameters for pwm */
static os_ushort pins_pwm_ccd_clock_prm[]= {PIN_RV, PIN_RV, PIN_RESOLUTION, 1, PIN_TIMER_SELECT, 0, PIN_INIT, 1, PIN_HPOINT, 0, PIN_FREQENCY_KHZ, 800};
static os_ushort pins_pwm_dimmer_led_prm[]= {PIN_RV, PIN_RV, PIN_RESOLUTION, 12, PIN_FREQENCY, 5000, PIN_MAX, 4095, PIN_INIT, 0};

/* Parameters for spi */
static os_ushort pins_spi_tft_spi_prm[]= {PIN_RV, PIN_RV, PIN_DC, 2, PIN_SCLK, 18, PIN_MOSI, 23, PIN_MISO, 19};
...
static os_ushort pins_cameras_ccd_prm[]= {PIN_RV, PIN_RV, PIN_TIMER_SELECT, 1, PIN_B, 21, PIN_C, 32, PIN_A, 36, PIN_D, 35, PIN_B_BANK, 1, PIN_C_BANK, 2};

/* Parameters for uart */
static os_ushort pins_uart_uart2_prm[]= {PIN_RV, PIN_RV, PIN_RX, 16, PIN_SPEED, 96, PIN_TX, 17};
