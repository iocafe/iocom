...
/* Parameters for pwm */
static os_ushort pins_pwm_ccd_clock_prm[]= {PIN_RV, PIN_RV, PIN_TIMER_SELECT, 0, PIN_RESOLUTION, 1, PIN_HPOINT, 0, PIN_FREQENCY_KHZ, 800, PIN_INIT, 1};
...
static os_ushort pins_cameras_ccd_prm[]= {PIN_RV, PIN_RV, PIN_C_BANK, 2, PIN_D, 35, PIN_B_BANK, 1, PIN_C, 32, PIN_TIMER_SELECT, 1, PIN_A, 36, PIN_B, 21};
