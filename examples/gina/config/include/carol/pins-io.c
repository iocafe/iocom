...
/* Parameters for pwm */
static os_ushort pins_pwm_ccd_clock_prm[]= {PIN_RV, PIN_RV, PIN_RESOLUTION, 1, PIN_HPOINT, 0, PIN_TIMER_SELECT, 0, PIN_INIT, 1, PIN_FREQENCY_KHZ, 800};
static os_ushort pins_pwm_dimmer_led_prm[]= {PIN_RV, PIN_RV, PIN_RESOLUTION, 12, PIN_INIT, 0, PIN_MAX, 4095, PIN_FREQENCY, 5000};

/* Parameters for spi */
static os_ushort pins_spi_tft_spi_prm[]= {PIN_RV, PIN_RV, PIN_DC, 2, PIN_MISO, 19, PIN_SCLK, 18, PIN_MOSI, 23};

/* Parameters for timers */
static os_ushort pins_timers_ccd_data_prm[]= {PIN_RV, PIN_RV, PIN_TIMER_SELECT, 0, PIN_TIMER_GROUP_SELECT, 0, PIN_FREQENCY_KHZ, 100, PIN_INTERRUPT_ENABLED, 1};
PINS_INTCONF_STRUCT(pin_ccd_data_intconf)

/* Parameters for cameras */
static os_ushort pins_cameras_ccd_prm[]= {PIN_RV, PIN_RV, PIN_A, 36, PIN_C_BANK, 2, PIN_D, 35, PIN_TIMER_SELECT, 1, PIN_B_BANK, 1, PIN_B, 21, PIN_C, 32};
