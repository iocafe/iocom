    ...
    os_char *argv[])
{
     ...
     */
#if PINS_CAMERA
    ioc_initialize_brick_buffer(&video_output, &gina.ccd, &ioboard_root, 4000, IOC_BRICK_DEVICE);
    ...
    void *context)
{
    ...
    {
        pins_store_photo_as_brick(photo, &video_output, PINS_DEFAULT_CAM_IMG_COMPR);
    }
}
#endif
