...
def make_common_header(common_c_file):
    ...
    hfile.write('/* This file is generated by generate_c_code.py script, do not modify. */\n')
    for fname in CFILES:
...
def make_common_cfile(common_c_file):
    ...
    cfile.write('/* This file is generated by generate_c_code.py script, do not modify. */\n')
