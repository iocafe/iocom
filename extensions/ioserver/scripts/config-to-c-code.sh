...
${BINTOC} -v ioapp_account_config ${MYACCOUNTS}.binjson -o ${MYINCLUDE}/accounts-mblk-binary.c
...
${BINTOC} -v ioapp_account_defaults ${MYACCOUNTSDEFAULTS}.binjson -o ${MYINCLUDE}/account-defaults.c
