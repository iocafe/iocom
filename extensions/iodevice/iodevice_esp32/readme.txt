gazerbeam_esp32 directory - The ESP32 build system workaround
14.3.2026/Pekka 

In ESP_IDF the directory name is component name: The ESP-IDF build system identifies components based on the name of 
the directory containing the CMakeLists.txt file. Here, a directory named gazerbeam_esp32 is treated as the 
component gazerbeam_esp32.
