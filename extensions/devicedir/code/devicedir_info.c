    ...
    os_short flags)
{
    ...
    devicedir_append_str_param(list, "device_name", root->device_name, DEVICEDIR_FIRST|DEVICEDIR_NEW_LINE|DEVICEDIR_TAB);
    if (root->device_nr == IOC_AUTO_DEVICE_NR) {
        devicedir_append_str_param(list, "device_nr", "*", DEVICEDIR_NEW_LINE|DEVICEDIR_TAB);
    }
    else {
        devicedir_append_int_param(list, "device_nr", root->device_nr, DEVICEDIR_NEW_LINE|DEVICEDIR_TAB);
    }

    devicedir_append_str_param(list, "connect", "*", DEVICEDIR_NEW_LINE|DEVICEDIR_TAB);
